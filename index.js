console.log('<!-- Я не списую,я просто захотів коментарями зробити завдання зрозумілішими, тому що в минулому завданні було дуже багато масивів  (╥_╥) -->');
// Task 1
const bankAccounts = [
...
const sortedFriendsWithName = friends.sort((a,b) => a.friends.length - b.friends.length).map(friend => friend.name)
console.log(sortedFriendsWithName);
console.log('<!-- Розфасовані друзі по object в масиві-->');
const sortedFriends = friends.sort((a,b) => a.friends.length - b.friends.length)
...
const peoples = [
  ...
  console.log(allSkills.sort((prevName, nextName) => {
